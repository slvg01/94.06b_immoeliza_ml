...
def train():
    ...
    # Create the Random Forest regressor with specified parameters
    ...
    with gzip.open("models/RandomForest_artifacts.joblib.gz", "wb") as f:
        joblib.dump(artifacts, f, compress=("gzip", 3))
